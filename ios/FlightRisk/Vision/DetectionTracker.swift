...
///
/// Thread safety: all mutations are guarded by `OSAllocatedUnfairLock` for
/// hot-path performance. This class is `@unchecked Sendable` because all
